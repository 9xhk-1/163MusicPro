...
const AudioFingerprintRuntime = () => {
  ...
  const UTF8Decoder = 'undefined' != typeof TextDecoder ? new TextDecoder('utf8') : void 0
  ...
  const wasmBinaryFile = WASM_BINARY_PLACEHOLDER
      ...
      i = (t = ct(t)).includes('j')
        ? ((r = t),
          ...
          function () {
            ...
            for (let t = 0; t < arguments.length; t++) o[t] = arguments[t]
            return oe(r, n, o)
          })
        : it(e)
    return (
      'function' != typeof i && vt('unknown function pointer with signature ' + t + ': ' + e),
      i
    )
  }
  let ae = void 0
  ...
  function le(t, e, r, n, o) {
    ...
    if (
      ...
      for (s = a ? 1 : 2; s < e.length; ++s) {
        const m = 1 === s ? 'thisWired' : 'arg' + (s - 2) + 'Wired'
    ...
    return (
      ...
      (function (t, e) {
        ...
        const r = ht(t.name || 'unknownFunctionName', function () {})
  ...
  function me() {
    for (let t = 5; t < de.length; ++t) if (void 0 !== de[t]) return de[t]
    return null
  }
  var ve = {
    toValue: function (t) {
...
function instantiateRuntime() {
  return new Promise((resolve, reject) => {
    const fpRuntime = AudioFingerprintRuntime()
